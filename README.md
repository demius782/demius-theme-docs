...
这是 [Demius](https://github.com/demius782/demius) Hugo 主题的文档站，使用 VuePress 2 与 [vuepress-theme-hope](https://github.com/vuepress-theme-hope/vuepress-theme-hope) 构建。
...
自定义域名已写入 `docs/.vuepress/public/CNAME`。DNS 服务商处将 `hugo.demius.tech` 配置为指向 GitHub Pages 的 CNAME 目标后即可生效。
